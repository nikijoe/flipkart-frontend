...
export default function AddressForm(props) {
    ...
    const onAddressSubmit = () => {
        const payload = {
            address: {
                name, mobileNumber, pinCode, locality,
                address, cityDistrictTown, state, landmark, 
                alternatePhone, addressType
            }
        }        
        console.log(payload)
        if(id){
        ...
        <>
                ...
                <div className='flexRow'>
                    ...
                    <div>
                        ...
                        <div className='flexRow'>
                            <div>
                                <input type='radio' onClick={()=> setAddressType('home')} 
                                name='addressType'value='home' />
                                <span>Home</span>
                            </div> 
                            <div>
                                <input type='radio' onClick={()=> setAddressType('work')} 
                                value='work' name='addressType' />
                                <span>Work</span>
                            </div>    
                        </div> 
                    </div>
